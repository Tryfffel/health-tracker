...
- **Idag** (`overview`): påminnelser (dos/vikt/backup), platåvarning, sammanslaget kort "Kroppsbatteriet + Dagens form" (batteriet som siffra + 14-dagarsstaplar med drilldown, formens träningsrekommendation som text, ram färgad efter formnivå), hero med aktuell vikt/målprogress.
